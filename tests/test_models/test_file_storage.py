...
class TestFileStorage(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.UrchinA = self.objects["Amenity.19b4933a-55d0-4287-99a0-773c1dcab528"]
        self.UrchinB = self.objects["BaseModel.7152df91-ec26-4595-bf75-fd84f02a3bd9"]
        self.UrchinC = self.objects["City.f76cbf19-eb40-4901-88ca-569684490fd1"]
        self.UrchinP = self.objects["Place.52cf288d-f402-4564-a91f-06c71004c6b7"]
        self.UrchinR = self.objects["Review.ac984526-613a-4ec8-933d-ab32a5f924b9"]
        self.UrchinS = self.objects["State.125b2cf3-66d9-4185-b442-e8a49cb7801d"]
        self.UrchinU = self.objects["User.bf654f25-d81f-4d02-a3c0-1777c5bfeda5"]
